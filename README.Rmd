...
* Joindre le groupe *INESSS - Librairie R inesss* pour avoir accès au fichier d'installation.  
Code du groupe : **e7fs8f0**.
* Télécharger le fichier *inesss_x.y.z.tar.gz* sur votre poste où *x.y.z* indique le numéro de version.
