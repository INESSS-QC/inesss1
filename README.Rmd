...
Puisque Microsoft Teams est accessible par un navigateur web, il est conseillé d'y avoir déposé le dossier d'installation et de le télécharger par la suite si vous voulez utiliser la librairie sur le serveur de la RAMQ.
