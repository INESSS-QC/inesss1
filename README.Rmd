...
* Télécharger la version R 4.0.3 en cliquant [ici](https://cloud.r-project.org/bin/windows/base/old/4.0.3/R-4.0.3-win.exe) (ou la dernière version [ici](https://cloud.r-project.org/bin/windows/base/)).
