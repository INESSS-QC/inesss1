...
# Documentation
Les répertoires suivants contiennent toute la documentation en lien avec l'utilisation de la librairie R *inesss* :

* INESSS : `J:/GRP/A/5/A/INSCRIPTION/E_I/_Rpackage_inesss/Documentation`
