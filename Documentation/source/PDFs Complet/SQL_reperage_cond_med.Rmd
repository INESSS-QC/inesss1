...
## conn
Variable contenant la connexion entre R et Teradata. Voir `SQL_connexion`.
```{r}
...
## date_dx_var
Indique si on utilise la date d'admission (`admis`) ou la date de départ (`depar`) comme date de diagnostic lors de l'extraction des données. Voir section *SQL*.
```{r}
