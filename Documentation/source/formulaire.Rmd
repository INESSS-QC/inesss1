...
* **Bouton Réinitialiser Arguments :** Efface les `Codes Rx` inscrits (conserve les boîtes de saisie de texte) et force les paramètres par défaut (exclusion des codes de services `1` et `AD`).
