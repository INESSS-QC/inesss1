...
Pour installer une librairie R, il est préférable de redémarrer RStudio pour s'assurer qu'aucune librairie n'est utilisée.\newline Pour la première installation de la librairie R `inesss_DER`, inscrire le code ci-dessous dans la console (par défaut en bas à gauche de RStudio).
